...
#define SPR_ESR_SHADOW  (SPR_ESR_BASE + 1)
#define SPR_EPCR_SHADOW (SPR_EPCR_BASE + 1)
#define SPR_EEAR_SHADOW (SPR_EEAR_BASE + 1)
...
#define FABRIC_ADDRESS_REG SPR_PCCR(1)
#define FABRIC_DATA_REG SPR_PCCR(2)
#define FABRIC_STROBE_REG SPR_PCCR(3)
#define SHADOW_R1_REG SPR_PCCR(4)
#define ASSERTION_REG SPR_PCCR(5)
#define ATTACK_ENABLE_REG SPR_PCCR(6)
#define EPPC_REG SPR_PCCR(7)
...
#define NOP_CHAR        0x0004
#define NOP_REPORT_FIRST 0x0400     /* Report with number */
#define NOP_REPORT_LAST 0x03ff      /* Report with number */
#define NOP_EXIT_SUCCESS 0
#define NOP_EXIT_FAILURE -1
